...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $student->name ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('dob', $student->dob ?? '')); ?>">
        <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mb-3">
        ...
        <select name="college_id" id="college_id" class="form-control <?php $__errorArgs = ['college_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH /home/sss/myCollegeManager/resources/views/students/_form.blade.php ENDPATH**/ ?>